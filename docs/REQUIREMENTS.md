...
1. The system shall be able to handle user accounts, including login, registration, logout, and deletion.

2. The system shall be able to display player statistics.

3. The system shall be able to facilitate rock-paper-scissor matches.
