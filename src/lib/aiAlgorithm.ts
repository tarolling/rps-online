...
export default function setupAI() {
  ...
  const bothPatterns: Record<string, string> = {};
  const oppPatterns: Record<string, string> = {};
  const myPatterns: Record<string, string> = {};

  const both2Patterns: Record<string, string> = {};
  const opp2Patterns: Record<string, string> = {};
  const my2Patterns: Record<string, string> = {};
